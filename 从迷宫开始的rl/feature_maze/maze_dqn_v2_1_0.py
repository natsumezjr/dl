...
class TrainConfig:
    ...
    output_dir: str = "./v2.1.0"
    output_name: str = "v2.1.0_bfs_demo_replay"
...
def build_cfg_from_args(args) -> TrainConfig:
    output_name = args.output_name or "v2.1.0_bfs_demo_replay"
    cfg = TrainConfig(
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="./v2.1.0")
    parser.add_argument("--output-name", type=str, default="v2.1.0_bfs_demo_replay")
